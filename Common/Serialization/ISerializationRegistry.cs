namespace Lucent.Common.Serialization
{
    ...
    public interface ISerializationRegistry
    {
        ...
        bool IsSerializerRegisterred<T>();
        ...
        void Register<T>(IEntitySerializer<T> serializer);
        ...
        IEntitySerializer<T> GetSerializer<T>();
    }
    ...
    public static class ISerializationRegistryExtensions
    {
        ...
        public static void Guard<T>(this ISerializationRegistry registry)
        {
